...
def get_hours(seconds):
    ...
    Return the number of hours that elapsed since midnight given time in seconds. Return the
    hour as seen on a 24-hour clock.
...
def get_minutes(seconds):
    ...
    Return the number of minutes that have elapsed since midnight given the time past midnight in seconds.
...
def get_seconds(seconds):
    ...
    Return the number of seconds that elapsed since midnight give time in seconds.
...
def time_to_utc(utc_offset, time):
    ...
    >>> time_to_utc(+0,12.30)
    12.30
    >>> time_to_utc(+0.50,12.0)
    11.50
    >>> time_to_utc(-0.50,12.0)
    12.50
    >>> time_to_utc(-8.50,18.0)
    2.5
     >>> time_to_utc(-1.5, 0.0)
    1.5
    >>> time_to_utc(-1.5, 23.0)
    0.5
    """
